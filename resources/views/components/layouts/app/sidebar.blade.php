...
<flux:navlist.item icon="magnifying-glass-circle" :href="route('students.search')" :current="request()->routeIs('students.search')" wire:navigate>{{ __('Student 360° Profile') }}</flux:navlist.item>
...
<flux:navlist.item icon="presentation-chart-bar" :href="route('reports.portal-service-charge')" :current="request()->routeIs('reports.portal-service-charge')" wire:navigate>{{ __('Portal Charge') }}</flux:navlist.item>
